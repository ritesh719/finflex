                    ...
                    <ul class="list-unstyled components" id="accordion">
                        <div class="user-profile">
                            <div class="dropdown user-pro-body">
                                ...
                                <div class="mb-2"><a href="/admin/dashboard" class=""
                        ...
                        <li class="">
                            <a href="{{ route('admin.manageBranch') }}">
                                <i class="fa fa-building-o mr-2"></i> Branches
                            </a>
                        </li>
                        <li class="">
                        ...
                        <li class="">
                            <a href="#homeSubmenu" class="accordion-toggle wave-effect" data-toggle="collapse"
                                aria-expanded="false">
                                <i class="fa fa-users mr-2"></i> Managers
                            </a>
                            <ul class="collapse list-unstyled" id="homeSubmenu" data-parent="#accordion">
                                <li><a href="{{ route('admin.manageCenterManager') }}">Center Managers (CM)</a></li>
                                <li><a href="{{ route('admin.manageBranchManager') }}">Branch Managers (BM)</a></li>
                            </ul>
                        </li>
                        <li class="">
                            <a href="{{ route('admin.addfunds') }}">
                                <i class="fa fa-money mr-2"></i> Add Funds
                            </a>
                        </li>
                    </ul>
                </nav>
